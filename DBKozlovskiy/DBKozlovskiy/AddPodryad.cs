...
{
    public partial class AddPodryad : Form
    {
        ...
        private void AddPodryad_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                int pod = int.Parse(dataGridView1.CurrentRow.Cells[0].Value.ToString());
                var working = textBox1.Text;

                var addQuery = $"insert into workingPodryad (idProject, idPodryad, nameWorkingPodryad) values ('{project}','{pod}','{working}')";
